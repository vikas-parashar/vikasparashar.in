 ...
 */
function(e){"use strict";e(document).ready(function(){e('a[href^="#"]').on("click",function(t){var n=e(e(this).attr("href"));n.length&&(t.preventDefault(),e("html, body").animate({scrollTop:n.offset().top-100},1e3))})})}(jQuery);